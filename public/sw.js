...
const createListResponse = (virtualFileSessionIdentifier, virtualFileStore) => {
...
const buildRequestedVirtualFilePath = (virtualFilePathSegments) => {
...
const handleVirtualRequest = (requestUniformResourceLocator) => {
